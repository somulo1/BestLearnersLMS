...
declare const commonDefaultProps: Omit<BumpCommonProps<DefaultBumpDatum, Record<string, unknown>>, 'onMouseEnter' | 'onClick' | 'onMouseMove' | 'onMouseLeave' | 'margin' | 'theme' | 'axisRight' | 'renderWrapper'>;
