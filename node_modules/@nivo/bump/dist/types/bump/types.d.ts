...
export type BumpSerie<Datum extends BumpDatum, ExtraProps extends BumpSerieExtraProps> = ExtraProps & {
    id: string;
    data: Datum[];
};
...
export type BumpPointComponent<Datum extends BumpDatum, ExtraProps extends BumpSerieExtraProps> = FunctionComponent<PointProps<Datum, ExtraProps>>;
...
export type BumpLabel<Datum extends BumpDatum, ExtraProps extends BumpSerieExtraProps> = ((serie: BumpSerie<Datum, ExtraProps>) => string) | boolean;
...
export type BumpSerieMouseHandler<Datum extends BumpDatum, ExtraProps extends BumpSerieExtraProps> = (serie: BumpComputedSerie<Datum, ExtraProps>, event: MouseEvent<SVGPathElement>) => void;
export type BumpPointMouseHandler<Datum extends BumpDatum, ExtraProps extends BumpSerieExtraProps> = (point: BumpPoint<Datum, ExtraProps>, event: MouseEvent) => void;
...
export type BumpCustomLayer<Datum extends BumpDatum, ExtraProps extends BumpSerieExtraProps> = FunctionComponent<BumpCustomLayerProps<Datum, ExtraProps>>;
export type BumpLayer<Datum extends BumpDatum, ExtraProps extends BumpSerieExtraProps> = BumpLayerId | BumpCustomLayer<Datum, ExtraProps>;
export type BumpLineTooltip<Datum extends BumpDatum, ExtraProps extends BumpSerieExtraProps> = FunctionComponent<{
    serie: BumpComputedSerie<Datum, ExtraProps>;
}>;
export type BumpPointTooltip<Datum extends BumpDatum, ExtraProps extends BumpSerieExtraProps> = FunctionComponent<{
...
export declare const isBumpPoint: <Datum extends BumpDatum, ExtraProps extends BumpSerieExtraProps>(point: BumpComputedSerie<Datum, ExtraProps> | BumpPoint<Datum, ExtraProps>) => point is BumpPoint<Datum, ExtraProps>;
export declare const isComputedBumpSerie: <Datum extends BumpDatum, ExtraProps extends BumpSerieExtraProps>(serie: BumpComputedSerie<Datum, ExtraProps> | BumpPoint<Datum, ExtraProps>) => serie is BumpComputedSerie<Datum, ExtraProps>;
interface BumpMeshCommonProps<Datum extends BumpDatum, ExtraProps extends BumpSerieExtraProps> extends BumpBaseCommonProps<Datum, ExtraProps> {
    useMesh: true;
...
interface BumpSerieCommonProps<Datum extends BumpDatum, ExtraProps extends BumpSerieExtraProps> extends BumpBaseCommonProps<Datum, ExtraProps> {
    useMesh: false;
...
export type BumpCommonProps<Datum extends BumpDatum, ExtraProps extends BumpSerieExtraProps> = BumpMeshCommonProps<Datum, ExtraProps> | BumpSerieCommonProps<Datum, ExtraProps>;
export type BumpResponsiveProps<Datum extends BumpDatum, ExtraProps extends BumpSerieExtraProps> = BumpCommonProps<Datum, ExtraProps> & BumpDataProps<Datum, ExtraProps> & {
    pointComponent?: BumpPointComponent<Datum, ExtraProps>;
} & MotionProps;
export type BumpSvgProps<Datum extends BumpDatum, ExtraProps extends BumpSerieExtraProps> = BumpResponsiveProps<Datum, ExtraProps> & Dimensions;
export {};
