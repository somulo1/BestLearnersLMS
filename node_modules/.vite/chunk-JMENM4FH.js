...
function quickselect(array2, k2, left = 0, right = array2.length - 1, compare = ascending_default2) {
  while (right > left) {
    if (right - left > 600) {
...
function transformer2() {
  var x0 = 0, x1 = 1, t04, t14, k10, transform, interpolator = identity2, clamp = false, unknown;
  function scale(x2) {
...
var timeDay = timeInterval((date2) => date2.setHours(0, 0, 0, 0), (date2, step) => date2.setDate(date2.getDate() + step), (start, end) => (end - start - (end.getTimezoneOffset() - start.getTimezoneOffset()) * durationMinute2) / durationDay2, (date2) => date2.getDate() - 1);
...
function ticker(year2, month2, week, day2, hour2, minute2) {
  ...
  function tickInterval(start, stop, count2) {
    ...
    if (i === 0)
      return millisecond2.every(Math.max(tickStep(start, stop, count2), 1));
...
function calendar(ticks, tickInterval, year2, month2, week, day2, hour2, minute2, second3, format2) {
  ...
  scale.copy = function() {
    return copy(scale, calendar(ticks, tickInterval, year2, month2, week, day2, hour2, minute2, second3, format2));
  };
  return scale;
}
function time() {
...
function transformer3() {
  var x0 = 0, x1 = 0.5, x2 = 1, s2 = 1, t04, t14, t22, k10, k21, interpolator = identity2, transform, clamp = false, unknown;
  function scale(x3) {
...
//# sourceMappingURL=chunk-JMENM4FH.js.map
