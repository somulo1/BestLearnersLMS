...
var import_invariant3 = __toModule(require_browser());
...
// node_modules/react-big-calendar/dist/react-big-calendar.esm.js
var import_chunk = __toModule(require_chunk());
...
function listScrollParents(element, list) {
  ...
  return isBody2 ? updatedList : updatedList.concat(listScrollParents(getParentNode(target)));
}
...
// node_modules/react-big-calendar/dist/react-big-calendar.esm.js
var import_defaults = __toModule(require_defaults());
...
var import_isBetween = __toModule(require_isBetween());
...
var import_minMax = __toModule(require_minMax());
...
function duration(start2, end2, unit, firstOfWeek) {
  if (unit === "day")
    unit = "date";
  return Math.abs(date_arithmetic_exports[unit](start2, void 0, firstOfWeek) - date_arithmetic_exports[unit](end2, void 0, firstOfWeek));
}
