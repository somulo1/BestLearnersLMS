...
} from "./chunk-N4AM6KDS.js";
import {
  require_scheduler,
  require_tracing
} from "./chunk-SEBMSOEZ.js";
import {
...
var EMPTY = {};
var catalogue = {};
var extend = (objects) => void (catalogue = __spreadValues(__spreadValues({}, catalogue), objects));
...
function createRenderer(roots2) {
  function diffProps(instance, _a, _c = {}, accumulative = false) {
    var _b = _a, {
      children: cN,
      key: kN,
      ref: rN
  ...
  function applyProps2(instance, data) {
    ...
    changes.forEach(([key, value, isEvent, keys2]) => {
      ...
      const isLinear = (rootState == null ? void 0 : (_rootState$gl = rootState.gl) == null ? void 0 : _rootState$gl.outputEncoding) === LinearEncoding;
      if (isEvent) {
        if (value)
        ...
        if (!isLinear && currentInstance[key] instanceof Texture)
  ...
  function createInstance(type, _e, root, hostContext, internalInstanceHandle) {
    var _f = _e, {
      args = []
...
var createStore = (applyProps2, invalidate2, advance2, props) => {
  ...
  const rootState = create((set, get) => {
    ...
    return {
      ...
      setFrameloop: (frameloop2 = "always") => set(() => ({
  ...
  rootState.subscribe(() => {
    ...
    if (size2 !== oldSize || viewport.dpr !== oldDpr) {
      if (!camera.manual && !(internal.lastProps.camera instanceof Camera)) {
...
var Canvas = React.forwardRef(function Canvas2(_a, forwardedRef) {
  var _b = _a, {
    children,
    fallback,
    tabIndex,
 ...
 */
//# sourceMappingURL=chunk-5Q45MS3O.js.map
