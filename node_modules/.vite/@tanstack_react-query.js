...
function parseMutationArgs(arg1, arg2, arg3) {
  ...
  return __spreadValues({}, arg1);
}
function parseFilterArgs(arg1, arg2, arg3) {
  return isQueryKey(arg1) ? [__spreadProps(__spreadValues({}, arg2), {
    queryKey: arg1
  }), arg3] : [arg1 || {}, arg2];
}
...
var MutationObserver = class extends Subscribable {
  ...
  mutate(variables, options) {
    ...
    this.currentMutation = this.client.getMutationCache().build(this.client, __spreadProps(__spreadValues({}, this.options), {
...
function hydrate(client, dehydratedState, options) {
  ...
  mutations.forEach((dehydratedMutation) => {
    ...
    mutationCache.build(client, __spreadProps(__spreadValues({}, options == null ? void 0 : (_options$defaultOptio = options.defaultOptions) == null ? void 0 : _options$defaultOptio.mutations), {
  ...
  queries.forEach(({
    ...
    if (query) {
      if (query.state.dataUpdatedAt < state.dataUpdatedAt) {
        ...
        } = _a, dehydratedQueryState = __objRest(_a, [
          "fetchStatus"
        ]);
    ...
    queryCache.build(client, __spreadProps(__spreadValues({}, options == null ? void 0 : (_options$defaultOptio2 = options.defaultOptions) == null ? void 0 : _options$defaultOptio2.queries), {
      queryKey,
      queryHash
